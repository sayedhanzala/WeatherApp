...
function fa() {
  if (en) {
    var e = en,
      t = tn;
    if (((tn = en = null), Ru(e), t)) for (e = 0; e < t.length; e++) Ru(t[e]);
  }
}
function da(e, t) {
  return e(t);
...
function td(e, t, n, r, l, o, i, u, s) {
  (Dn = !1), (Xr = null), bf.apply(ed, arguments);
}
...
var br = null;
function Io(e, t, n, r) {
  if (((br = null), (e = Pi(r)), (e = Rt(e)), e !== null))
...
var Vd = qe && "TextEvent" in window && !jn,
...
function Yn(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var l = n[r];
    if (!So.call(t, l) || !Me(e[l], t[l])) return !1;
  }
  return !0;
}
function Hu(e) {
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (v = E, d = y, c = 0, p = v; p; p = Bt(p)) c++;
...
function kt() {
  if (!oo && Ke !== null) {
    ...
    try {
      ...
      throw (Ke !== null && (Ke = Ke.slice(e + 1)), ga(Ri, kt), l);
    } finally {
      (A = t), (oo = !1);
    }
  }
...
function gc(e, t, n) {
  return jt & 21
    ? (Me(n, t) || ((n = Ea()), (H.lanes |= n), (At |= n), (e.baseState = !0)),
      t)
  ...
  return (
    ...
    e !== null && !pe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        et(e, t, l))
      : (B && n && Mi(t), (t.flags |= 1), se(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !pe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        et(e, t, l))
      : (B && r && Mi(t), (t.flags |= 1), se(e, t, n, l), t.child)
  );
}
...
function Ae(e, t, n, r) {
  ...
  ur(e, n, r),
    (!(j & 2) || e !== ee) &&
      (e === ee && (!(j & 2) && (Rl |= n), q === 4 && ut(e, ne)),
      ye(e, r),
      n === 1 && j === 0 && !(t.mode & 1) && ((dn = J() + 500), Cl && kt()));
}
function ye(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Ou(n), t === 1))
      e.tag === 0 ? dp(ks.bind(null, e)) : Ja(ks.bind(null, e)),
        sp(function () {
          !(j & 6) && kt();
        }),
        (n = null);
...
function Uc(e, t) {
  if ((($r = -1), (Hr = 0), j & 6)) throw Error(S(327));
  var n = e.callbackNode;
...
function ru(e, t) {
  ...
  try {
    ...
    (j = n), j === 0 && ((dn = J() + 500), Cl && kt());
  }
}
function Mt(e) {
  at !== null && at.tag === 0 && !(j & 6) && ln();
  var t = j;
  j |= 1;
  var n = Ne.transition,
    r = A;
...
function ou() {
  (q === 0 || q === 3 || q === 2) && (q = 4),
    ee === null || (!(At & 268435455) && !(Rl & 268435455)) || ut(ee, ne);
}
function ml(e, t) {
  var n = j;
  j |= 2;
  ...
  while (1);
  if (($i(), (j = n), (dl.current = r), X !== null)) throw Error(S(261));
  ...
  if (at !== null) {
    ...
    try {
      if (((Ne.transition = null), (A = 16 > e ? 16 : e), at === null))
        ...
        if (((e = at), (at = null), (hl = 0), j & 6)) throw Error(S(331));
        var l = j;
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            qo(t, r, e, n),
            (t = ei(null, t, r, !0, o, n)))
          : ((t.tag = 0), B && o && Mi(t), se(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Ti(t, n | 1), ye(t, J()), !(j & 6) && ((dn = J() + 500), kt()));
      }
      break;
    case 13:
      Mt(function () {
...
da = ru;
pa = Mt;
var Wp = { usingClientEntryPoint: !1, Events: [ar, Kt, xl, ca, fa, ru] },
  Pn = {
...
const Ch = (e) => {
  ...
  _h = We("AsyncFunction"),
  Nh = (e) => e && (Al(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  g = {
    isArray: vn,
    isArrayBuffer: Zc,
    isBuffer: Xp,
  ...
  yf = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !lm(n) && ((r = hi[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
const mi = { assertOptions: om, validators: mu },
  rt = mi.validators;
class vl {
  constructor(t) {
    (this.defaults = t),
...
Y.mergeConfig = pn;
Y.AxiosHeaders = Ge;
Y.formToJSON = (e) => pf(g.isHTMLForm(e) ? new FormData(e) : e);
Y.getAdapter = yf.getAdapter;
Y.HttpStatusCode = am;
Y.default = Y;
const cm = Y;
function fm() {
  const [e, t] = Pt.useState({}),
    [n, r] = Pt.useState(""),
    [l, o] = Pt.useState(null),
    u = `https://api.openweathermap.org/data/2.5/weather?q=${n}&units=metric&appid=7db70aa34a76446cf79edd7ebdeb4e26`,
    s = (v) => {
      v.key === "Enter" &&
        (cm.get(u).then((R) => {
          t(R.data);
  ...
  let f = a[h.getMonth()],
    m = h.getDate(),
    E = h.getFullYear(),
    y = h.getHours() + ":" + h.getMinutes() + ":" + h.getSeconds();
  return D.jsxs("div", {
    className: "app",
    children: [
      D.jsx("div", {
        className: "heading",
        children: D.jsx("h1", { children: "Know Your Weather" }),
      }),
      D.jsxs("div", {
          ...
          e.name !== void 0
            ? D.jsxs("div", {
                children: [
                  ...
                  D.jsxs("div", {
                    ...
                    children: [
                      D.jsxs("div", {
                        className: "city",
                        children: [
                          D.jsx("h1", { children: e.name }),
                          D.jsx("h3", { children: f + " " + m + ", " + E }),
                        ],
                      }),
                      D.jsxs("div", {
                        className: "temp",
                        children: [
                          e.main
                            ? D.jsxs("h1", { children: [e.main.temp, " °C"] })
                            : null,
                          D.jsx("h3", { children: y }),
                        ],
                      }),
                      D.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.main
                            ? D.jsx("p", { children: e.weather[0].main })
                            : null,
                          D.jsx("img", {
                            src: l,
                            alt: "weather_image",
                  ...
                  D.jsxs("div", {
                    ...
                    children: [
                      D.jsxs("div", {
                        className: "feels mx-5",
                        children: [
                          e.main
                            ? D.jsxs("p", {
                                children: [e.main.feels_like, " °C"],
                              })
                            : null,
                          D.jsx("p", {
                            className: "r-7",
                      ...
                      D.jsxs("div", {
                        className: "humidity mx-5",
                        children: [
                          e.main
                            ? D.jsx("p", { children: e.main.humidity })
                            : null,
                          D.jsx("p", {
                            className: "r-7",
                            style: { right: "17px", fontWeight: "700" },
                            children: "Humidty",
                          }),
                        ],
                      }),
                      D.jsxs("div", {
                        ...
                        children: [
                          e.wind
                            ? D.jsxs("p", { children: [e.wind.speed, " m/s"] })
                            : null,
                          D.jsx("p", {
                            className: "r-7",
                            style: { left: "7px", fontWeight: "700" },
                            children: "Wind",
                          }),
                        ],
                      }),
            ...
            : D.jsxs("div", {
                children: [
                  D.jsx("p", {
                    className: "else-msg1",
                    children: "Search your city to display the weather.",
                  }),
                  D.jsx("small", {
                    className: "else-msg",
                    children:
                      "(Make sure you are typing your city name correctly.)",
                  }),
                ],
              }),
        ],
...
wo.createRoot(document.getElementById("root")).render(
  D.jsx(Af.StrictMode, { children: D.jsx(fm, {}) })
);
